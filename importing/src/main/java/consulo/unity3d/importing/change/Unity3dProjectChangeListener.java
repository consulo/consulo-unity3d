...
public class Unity3dProjectChangeListener implements Disposable {
    ...
    public Unity3dProjectChangeListener(@Nonnull Project project, @Nonnull VirtualFileManager virtualFileManager) {
        ...
        myAssetsDirPointer = VirtualFilePointerManager.getInstance().create(StandardFileSystems.FILE_PROTOCOL_PREFIX + myProject.getPresentableUrl() + "/" + Unity3dPaths.ASSETS_DIRECTORY, this, null);
