...
public class UnityAssemblyContext {
    ...
    private final AsmDefDescriptor myAsmDefElement;
    ...
    UnityAssemblyContext(@Nonnull UnityAssemblyType type, @Nonnull String name, @Nullable VirtualFile asmdefFile, AsmDefDescriptor asmDefElement) {
        myType = type;
        myName = name;
    ...
    @Nullable
    public AsmDefDescriptor getAsmDefElement() {
