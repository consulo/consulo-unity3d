...
public interface CGKeywords
{
	Set<String> KEYWORDS = Set.of("asm", "asm_fragment", "auto", "case", "class", "column_major", "compile", "const", "const_cast", "continue", "decl", "default", "delete",
			...
			"vertexfragment", "vertexshader", "virtual", "volatile", "while", "break", "goto", "return", "true", "false", "NULL", "in", "inout", "static", "out",
			...
			"unsigned", "signed", "char", "short", "long", "double", "cint", "cfloat", "void");
}
