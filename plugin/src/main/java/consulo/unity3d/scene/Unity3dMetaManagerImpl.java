...
@Singleton
@ServiceImpl
public class Unity3dMetaManagerImpl implements Unity3dMetaManager, Disposable {
    ...
    @Inject
    public Unity3dMetaManagerImpl(Project project, VirtualFileManager virtualFileManager, MetadataService metadataService) {
        myProject = project;
